...
do mm-extract-asthma-01 // extract data for everyone with a eczema dx code (in HES/CPRD) who is eligible for HES/ONS linkage
do mm-extract-asthma-02Therapy // extract eczema therapy data (prescriptions and codes for therapy)
do mm-extract-asthma-03Exposed // identify those who fulfil the eczema definition (i.e. one dx code, and 2 therapy codes [on separate days])
do mm-extract-asthma-04EligibleCohort 	// identify exposed who are eligible for follow up - identify start and end of eligible follow-up
...
do mm-extract-asthma-05controlPool // identify two pools of potentially unexposed individuals: 
...
do mm-extract-asthma-06matching 	// match on age, sex and practice to identify unexposed cohorts (for mortality and cancer studies, and each of main, sens1 and sens2 analyses)
