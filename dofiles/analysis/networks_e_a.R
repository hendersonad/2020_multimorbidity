# Simple file to (re)run logistic regressions, Jaccard distance
# Multimorbidity
# 
...
jac1 <- function(DW, E1, E2, Z=NULL){
  ...
  K <- c("(Intercept) = 0","(Intercept) + caTRUE = 0",                       #controls in men age50, cases in men age50
         "(Intercept) - 4*exy5 = 0","(Intercept) + caTRUE - 4*exy5 = 0",     #same but 1 year followup
         "(Intercept) + 5*exy5 = 0","(Intercept) + caTRUE + 5*exy5 = 0",     #same but 10 yrs followup
  ...
  re <- data.frame(data=DW, f1=E1, f2=E2, Adj=zv,
                   ...
                   m0_50_01=lc[3,1], lm0_50_01=lc[3,2], um0_50_01=lc[3,3], pm0_50_01=lp[3],
                   m1_50_01=lc[4,1], lm1_50_01=lc[4,2], um1_50_01=lc[4,3], pm1_50_01=lp[4], 
                   m0_50_10=lc[5,1], lm0_50_10=lc[5,2], um0_50_10=lc[5,3], pm0_50_10=lp[5],
                   m1_50_10=lc[6,1], lm1_50_10=lc[6,2], um1_50_10=lc[6,3], pm1_50_10=lp[6], 
                   w0_50=lc[7,1], lw0_50=lc[7,2], uw0_50=lc[7,3], pw0_50=lp[7],
                   w1_50=lc[8,1], lw1_50=lc[8,2], uw1_50=lc[8,3], pw1_50=lp[8], 
                   m0_18=lc[9,1], lm0_18=lc[9,2], um0_18=lc[9,3], pm0_18=lp[9],
                   m1_18=lc[10,1], lm1_18=lc[10,2], um1_18=lc[10,3], pm1_18=lp[10], 
                   w0_18=lc[11,1], lw0_18=lc[11,2], uw0_18=lc[11,3], pw0_18=lp[11],
                   w1_18=lc[12,1], lw1_18=lc[12,2], uw1_18=lc[12,3], pw1_18=lp[12], 
...
ev <- sort(names(dpw)[grep('fi_', names(dpw))])[1:19]
edj <- NULL
t0 <- Sys.time()
